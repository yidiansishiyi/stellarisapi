...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
//        com.stellarisapi.stellarisapiclientsdk.model.User user = new com.stellarisapi.stellarisapiclientsdk.model.User();
//        user.setUsername("test");
//        String username = stellarisapiClient.getUsernameByPost(user);
...
//        stellarisapiClient tempClient = new stellarisapiClient(accessKey, secretKey);
//        Gson gson = new Gson();
//        com.stellarisapi.stellarisapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.stellarisapi.stellarisapiclientsdk.model.User.class);
